// Halo `terrain / static_sh` entry point — vertex + pixel main.
//
// Faithful port of `terrain_fx.hlsl` static_sh path
// (entry_points_fx.hlsl-style umbrella inlined for forward-pass).
