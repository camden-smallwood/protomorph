// Halo `foliage / static_sh` entry point.
//
// Faithful port of `foliage_fx.hlsl` static_sh path (per
// `reference_foliage_fx_blueprint.md`). Used by riverworld tree
// leaves (`riverworld_tree_leaf{a,b,c}.shader_foliage`).
//
